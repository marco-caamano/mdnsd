...
- [Section 1: mDNS Header (DNS Wire Format, 12 bytes)](#section-1-mdns-header-dns-wire-format-12-bytes)
  ...
  - [Detailed Bit-Field Diagram](#detailed-bit-field-diagram)
  - [Header Fields Explained](#header-fields-explained)
- [Section 2: Question Section (Variable Length)](#section-2-question-section-variable-length)
  ...
  - [QNAME Format (Domain Name Compression)](#qname-format-domain-name-compression)
  - [QTYPE (Query Type) - 2 bytes](#qtype-query-type---2-bytes)
  - [QCLASS (Query Class) - 2 bytes](#qclass-query-class---2-bytes)
- [Section 3,4,5: Answer/Authority/Additional Sections (Variable Length)](#section-345-answerauthorityadditional-sections-variable-length)
  ...
  - [Detailed Structure](#detailed-structure-1)
  - [CLASS Field (With Cache Flush Bit)](#class-field-with-cache-flush-bit)
  - [TTL (Time-To-Live) - 4 bytes](#ttl-time-to-live---4-bytes)
  - [Resource Data (RDATA) - Type-Specific](#resource-data-rdata---type-specific)
- [Complete Packet Example](#complete-packet-example)
  - [mDNS A Record Query](#mdns-a-record-query)
  - [mDNS A Record Response](#mdns-a-record-response)
  - [mDNS SRV Record Query](#mdns-srv-record-query)
  - [mDNS SRV Record Response](#mdns-srv-record-response)
  - [mDNS TXT Record Query](#mdns-txt-record-query)
  - [mDNS TXT Record Response](#mdns-txt-record-response)
